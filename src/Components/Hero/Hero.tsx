  ...
  return (
    <div className="container hero" id="hero">
      <div className="hero-text">
        ...
        <p>
          Bem-vindo à ACT Code, onde transformamos os desafios de negócios em
          soluções galácticas. Nossa missão é impulsionar o crescimento e a
          ...
          ACT Code e descubra como podemos levar seu negócio a novas alturas no
          universo digital.
        </p>
